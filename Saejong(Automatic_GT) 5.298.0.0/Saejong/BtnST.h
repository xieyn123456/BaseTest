...
public:
	...
	bool m_PressEx;
	void Set3DLook();
	void SetTextFontEx(long FontHight,long FontWeight,LPCTSTR FontName);
	void SetTextFont(int FontHight,LPCTSTR FontName);
	void SetText(CString str);
	void SetFocuseColor(COLORREF color);
	void SetBkColor(COLORREF color);  //copy function from CButton.h
  ...
  /*增加位图截取0507*/
	DWORD SetBitmapsCut(int nBitmapIn, COLORREF crTransColorIn,UINT unLeftTop,UINT unRightBottom);
	DWORD SetBitmapsCut(HBITMAP hBitmapIn, COLORREF crTransColorIn,UINT unLeftTop,UINT unRightBottom);
...
private:
	...
	HBITMAP CreateBitmapMask(HBITMAP hSourceBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTransColor);
	 /*增加位图截取0507*/
	HBITMAP CreateBitmapMask(HBITMAP hSourceBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTransColor,UINT unLeftTop,UINT unRightButtom);
	...
	COLORREF	m_ForeColor;        // copy from "CMyButton.h" for function "setbkcolor"
	COLORREF    m_FocuseColor;
	COLORREF    m_BkColor;
...
#pragma pack()
	...
	DECLARE_MESSAGE_MAP()
public:
	BOOL		m_Display;			// Is a Display button?
	void SetSideColor(COLORREF color);
};
